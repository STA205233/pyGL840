...
def run():
    ...
    daq = Daq.DataAcquisition(
        config, csv_file_base=f"/Users/nanograms/work/quicklook/GL840Data/{dt_now.year:04}{dt_now.month:02}{dt_now.day:02}/{dt_now.hour:02}{dt_now.minute:02}{dt_now.second:02}_", mongo=mongo, override=False, num_event_per_file=10000)
